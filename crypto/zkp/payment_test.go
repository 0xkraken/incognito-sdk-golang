...
func TestPaymentProofToBytes(t *testing.T){
	...
	senderKeyBN := new(crypto.Scalar).FromBytesS(keyWallet.KeySet.PrivateKey)
	senderPKPoint := new(crypto.Point)
